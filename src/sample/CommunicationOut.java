...
public class CommunicationOut implements Runnable {
    ...
    CommunicationOut(Socket s, ObjectOutputStream out, DataStructure outQ, TextField status) {
        socket = s;
        writer = out;
        outQueue = outQ;
        statusText = status;
    ...
    CommunicationOut(Socket s, ArrayList<ObjectOutputStream> outs, DataStructure outQ, TextField status) {
        socket = s;
        outStreams = outs;
        outQueue = outQ;
        statusText = status;
